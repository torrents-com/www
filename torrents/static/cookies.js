;(function($){$.cookiesLaw={new_cid:false,cid:false,notified:false,hide_msg:false,start_scripts:false,
    ...
    run_scripts:function(){if(!this.start_scripts)return;if(this.new_cid){this.new_cid=false;$.cookie("__cid",this.cid,{expires:730,path:'/'})};this.start_scripts();this.start_scripts=false;},
