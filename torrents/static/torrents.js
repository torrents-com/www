...
$(function(){
    ...
    if (adult_content&&!$.cookie("adult_confirm")){trackGAEvent('Adult confirm', "Ask");$.colorbox({html:"<div id='adult_confirm' class='adult_confirm title big_icon porn'><span></span><div><h1>"+ gbody.data("adult_confirm_title") +"</h1></div><p>"+gbody.data("adult_confirm_desc")+"</p><a id='yes_button' href='#'>"+gbody.data("adult_confirm_yes")+"</a><a data-track='Adult confirm,No,' href='/'>"+gbody.data("adult_confirm_no")+"</a></div>", width:"600px",close:false,overlayClose:false,fixed:true});$("#adult_confirm a[data-track]").each(data_track);$("#yes_button").click(function(e){e.preventDefault();$.cookie("adult_confirm",1,{path:'/'});trackGAEvent('Adult confirm',"Yes");$.colorbox.close()});}
