...
def create_app(config=None, debug=False):
    ...
    assets.register('js_torrents', Bundle('jquery.js', 'jquery.treeview.js', 'jquery.cookie.js', 'jquery.colorbox-min.js', 'torrents.js', 'cookies.js', filters='rjsmin', output='gen/torrents.js'), )
